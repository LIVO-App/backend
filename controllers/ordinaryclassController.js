...
module.exports.get_classes = async (req, res) => {
    ...
    let data_classes = classes.map((cls) => {
        return {
            study_year_ref: {origin: "/api/v1/study_year", single: true, data:[cls.study_year_id]},
            study_address_ref: {origin: "/api/v1/study_addresses", single: true, data: [cls.study_address_id]},
